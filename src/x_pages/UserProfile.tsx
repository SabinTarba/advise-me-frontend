            ...
            <div className="mt-5">
                ...
                <div className='flex gap-5 h-1/4 items-center justify-center'>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <span className="text-blue-600 text-xs flex gap-1 hover:underline">{user?.url1 && <AiOutlineLink/>}<a rel="noreferrer" target="_blank" href={user?.url1}>{user?.url1}</a></span>
                        <span className="text-blue-600 text-xs flex gap-1 hover:underline">{user?.url2 && <AiOutlineLink/>}<a rel="noreferrer" target="_blank" href={user?.url2}>{user?.url2}</a></span>
